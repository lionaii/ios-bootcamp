...
class MediaPostsHandler: NSObject {
    ...
    func getPosts() {
        ...
        let textPost3 = TextPost(textBody: "A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!A lot of text!", userName: "Jeff", timestamp: Date(timeIntervalSince1970: 40001))

        mediaPosts = [imagePost1, imagePost2, textPost1, textPost2, textPost3]
